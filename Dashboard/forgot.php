...
<head>
    ...
    <link rel="stylesheet" href="../cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.html" />
    ...
    <script src="../../code.tidio.co_443/r9q6huh2ljuktxdjbxh0hap1mc3eihut.js" async></script>
</head>
...
<body class="menuclose menuclose-right" style="background:gray">
    ...
    <header class="navbar-fixed">
        <nav class="navbar navbar-toggleable-md sign-in-header">
            <div class="sidebar-left"> <a class="navbar-brand imglogo" href="login.html"></a> </div>
            <div class="col"></div>
            <div class="sidebar-right pull-right">
                <ul class="navbar-nav  justify-content-end">
                    <li style="margin:4px"><a href="#" class="btn btn-link text-white"></a></li>
                    <li style="margin:4px"><a href="../index-2.html" class="btn btn-primary">Home</a></li>
                    <li style="margin:4px"><a href="login.html" class="btn btn-primary">Login</a></li>
                    <li style="margin:4px"><a href="register.html" class="btn btn-primary">Register</a></li>
                </ul>
            </div>
        </nav>
    </header>
...
<div class="wrapper-content-sign-in p-0">
    <div class="container text-center">
        ...
        <form class="form-signin1 light" method="POST">
            ...
            <br>
            <input type="submit" name="submit" class="btn btn-lg btn-primary btn-round" style="background:" value="Reset"><br>
        </form>
        <p class="mt-3" style="color:crimson">Already have password? <a href="login.html" class="text-white">Login
                here!</a></p>
    </div>
</div>
...
<script async src='https://d2mpatx37cqexb.cloudfront.net/delightchat-whatsapp-widget/embeds/embed.min.js'></script>
        <script>
          var wa_btnSetting = {"btnColor":"#16BE45","ctaText":"WhatsApp Us","cornerRadius":40,"marginBottom":20,"marginLeft":20,"marginRight":20,"btnPosition":"right","whatsAppNumber":"48539430144","welcomeMessage":"welcome to Expressminning Support Desk. How can I help you?","zIndex":999999,"btnColorScheme":"light"};
          window.onload = () => {
